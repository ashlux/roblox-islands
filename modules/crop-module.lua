...
function clickScreen(area)
    ...
    if area == "middle" then
        VirtualInputManager:SendTouchEvent(1, 1, screenSize.X/2, screenSize.Y/2)
        task.wait()
        VirtualInputManager:SendMouseButtonEvent(1, 0, screenSize.X/2, screenSize.Y/2)
    
    elseif area == "corner" then
        VirtualInputManager:SendTouchEvent(1, 1, 0, 0)
        task.wait()
        VirtualInputManager:SendMouseButtonEvent(1, 0, 0, 0)
    end
